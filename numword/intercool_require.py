...
def convert(request):
    ...
    if request.POST:
        ...
        if number_count == 1:
            if actual_number == 1:
                number = 'One'
                return {'number': number, 'previous': number}
            if actual_number == 2:
                number = 'Two'
                return {'number': number, 'previous': number}
            if actual_number == 3:
            ...
            if number in mapping:
                return {'number': mapping[number],  'previous': number}
            ...
            return {'number': result, 'previous': number}
        # Hundred
        elif number_count == 3:
        ...
        #  THOUSAND
            ...
            return {'previous': number, 'number': result}
